                ...
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <span class="icon-bar"></span>                        
                            ...
                            <a class="navbar-brand" href="inscription_acheteur.php")>
            ...
            <div id="contenu" class="container-fluid text-center">    
                ...
                <div class="col-sm-8 text-left"> 
                    ...
                    <form class="form-horizontal needs-validation"  method="POST" action="">
                        ...
                        <div class="text-right">
                            <input type="submit" onclick="window.location.href='connexion_acheteur.php';" value="Après votre inscription, cliquez ici pour être redirigé vers la page d'accueil du site.">
                        </div>
                    </form>
                </div>
            </div>
