...
<html>
    <head>
        ...
        <title>Article Achat Meilleure Offre</title>
        <meta charset="utf-8">
                ...
                <div id="contenu" class="container-fluid"> 
                    <div class=" row  content " >
                        <div class="alert alert-info">
                            Catégorie : Achat Meilleure Offre
                        </div>
                                        ...
                                        <section class="section content">
                                            <div class="container-fluid">
                                                ...
                                                <div class="right-col">
                                                    <div class="cart-totals-1">
                                                        ...
                                                        <form action="#" method="get" accept-charset="utf-8">
                                                            <table>
                                                                <tbody>
                                                                    <tr >
                                                                        <td><label class="control-label" for="prix">Pris a l'affiche:</label></td>
                                                                        <td class="subtotal">$1,591.00</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><label class="control-label" for="prix">Saisir Prix:</label></td>
                                                                        <td><input type="number"  id="prix"  class="form-control"placeholder="220€"></td>
                                                                    </tr>               
                                                                </tbody>
                                                            </table>
                                                        </form>   
                                                    ...
                                                    <a href="#" class="fin round-fin-btn-crea" title="">
                                                        <i class="fa fa-check"></i> Encherir
                                                    </a>
