...
<html>
    ...
    <title>Article Achat Enchère</title>
        <meta charset="utf-8">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="myNavbar">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="nav-item"><a class="nav-link" href="profil_utilisateur.php" title="Mon Compte">Mon compte</a></li>
...
$id_article= $_GET['id'];// Si l'id est précisé dans l'URL…
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="right-col">
                                                    <div class="cart-totals-1">
                                                        ...
                                                        <form action="encherir.php" method="post" accept-charset="utf-8">
                                                            <table>
                                                                <tbody>
                                                                  
                                                                        <td><label class="control-label" for="prix">Saisir Prix:</label></td>
                                                                        <td><input type="number"  id="prix" name="enchere"  class="form-control"placeholder="220€" value="enchere"></td>
                                                                    </tr>               
                                                                </tbody>
                                                            </table>
        ...
        ?>      
                                                    ...
                                                    <a href="accueil.php" class="fin round-fin-btn-crea" title="">
